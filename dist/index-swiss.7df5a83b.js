...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/swiss/dist/swiss.mjs":[function(require,module,exports) {
"use strict";
...
exports.component = componentEnhancer;
exports.compose = compose;
exports.element = element$1;
exports.extend = extend$1;
exports.propsToAttrs = propsToAttrs;
exports.renderer = rendererEnhancer;
...
function extend(Base, init) {
  function Class(a, b, c) {
    ...
    const supr = () => {
      return typeof Reflect === 'undefined' ? Base.call(el) : Reflect.construct(Base, [], el.constructor);
    };
...
function element(name, enhancer, options) {
  ...
  forwardCallbacks(SwissElement.prototype, ['connected', 'disconnected', 'attributeChanged', 'adopted']); // `observedAttributes` have to be on the Class before construction.
...
function forwardCallbacks(proto, callbacks) {
  callbacks.forEach(name => {
    ...
    proto[cb] = function (...args) {
      if (dispatching) return; // eslint-disable-next-line fp/no-this
...
function append(parent, nodes) {
  return [].concat(nodes).map(node => parent.appendChild(node instanceof Node ? node : document.createTextNode('' + node)));
}
...
function componentEnhancer(component) {
  return createElement => (options, a, b, c) => {
    ...
    function update(props) {
      if (props) extend$1(el, props); // If `renderer` is defined, the generated html is passed to `render`.
    ...
    function render(html) {
      ...
      const renderer$1 = el.renderer || renderer;
      renderer$1(el.renderRoot(), html, oldHtml);
      oldHtml = html;
    }
...
const options = {
  enhancers: [propsToAttrs(), componentEnhancer()]
};
/**
 * Defines a custom element in the `CustomElementRegistry` which renders the component which is passed as an argument.
 *
...
function element$1(name, component, enhancer, opts) {
  if (isFunction(name)) {
    opts = enhancer;
    enhancer = component;
    component = name;
  ...
  enhancer = compose(enhancer, ...options.enhancers);
  return element(name, enhancer, opts);
}
/**
...
function rendererEnhancer(customRenderer = renderer) {
  return createElement => (...args) => {
    const element = createElement(...args);
    let render;
    let renderWays = [// default
    (root, html, old) => customRenderer(root, html, old), // lit-html, htm-preact
    (root, html, old) => customRenderer(html, root, old), // superfine
    (root, html, old) => customRenderer(old, html, root), // lighterhtml
...
},{}],"node_modules/swiss/hooks/dist/swiss-hooks.mjs":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.afterPaint = afterPaint;
exports.clean = clean;
...
function clean(cleaner) {
  cleaner.__hooks && cleaner.__hooks._list.forEach(hook => hook._cleanup && hook._cleanup());
}

function runBeforeLifeCycles() {
  const hooks = currentUpdate.__hooks;
  if (!hooks) return; // Is possible if a 2nd render is called before the flush after paint.
...
function getHookState(index) {
  ...
  const hooks = currentUpdate.__hooks || (currentUpdate.__hooks = {
    _list: [],
    _pendingEffects: [],
...
function useReducer(reducer, initialState, init) {
  ...
  if (hookState._update == null) {
    ...
    hookState._value = [init == null ? invokeOrReturn(null, initialState) : init(initialState), action => {
...
function afterPaint(update) {
  if (!update._afterPaintQueued && (update._afterPaintQueued = true) &&
  /* eslint-disable-next-line */
...
_swiss.options.enhancers = [].concat(hooks, _swiss.options.enhancers);
},{"swiss":"node_modules/swiss/dist/swiss.mjs"}],"src/storeHook.js":[function(require,module,exports) {
"use strict";
...
var _hooks = require("swiss/hooks");
...
function useStore(identifier) {
  ...
  var _useState = (0, _hooks.useState)(store.state),
...
},{"swiss/hooks":"node_modules/swiss/hooks/dist/swiss-hooks.mjs"}],"src/reducer.js":[function(require,module,exports) {
"use strict";
...
var elementOne = function elementOne() {
  ...
  return (0, _litHtml.html)(_templateObject(), state.name);
};
...
var elementTwo = function elementTwo() {
  ...
  return (0, _litHtml.html)(_templateObject2(), state.name, function () {
    return dispatch({
      type: 'change'
    });
  });
...
(0, _swiss.element)("ele-one", elementOne, (0, _swiss.renderer)(_litHtml.render));
(0, _swiss.element)("ele-two", elementTwo, (0, _swiss.renderer)(_litHtml.render));

function App() {
  return (0, _litHtml.html)(_templateObject3());
}

(0, _swiss.element)("my-app", App, (0, _swiss.renderer)(_litHtml.render));
},{"swiss":"node_modules/swiss/dist/swiss.mjs","./storeHook":"src/storeHook.js","./reducer":"src/reducer.js","lit-html":"node_modules/lit-html/lit-html.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index-swiss.js"], null)
//# sourceMappingURL=/index-swiss.7df5a83b.js.map